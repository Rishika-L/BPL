...
const Navbar = () => {
  return (
    <div className="h-14 bg-[#272757] text-[#FFFFFF] flex items-center justify-between px-6 fixed top-0 left-0 right-0 z-50">
      <img src={login} alt="logo" className="w-40 object-cover" />
