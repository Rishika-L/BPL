      ...
      >
        {fields.map((field) => (
          ...
          >
            ...
            {/*  FILE */}
            {field.type === "file" && (
              <div className="bg-[#e4e5f2] rounded p-3 w-80">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <div className="-ml-1">
                    <p className="text-sm font-medium text-[#272757]">
                      {field.placeholder || "Add Profile Image"}
                    </p>
                    <p className="text-[10px] -ml-6 text-gray-500 whitespace-nowrap">
                      Image size less than 1MB · JPG / JPEG / PNG
                    </p>
                  </div>
